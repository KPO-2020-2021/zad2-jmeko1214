...
${TBIN}/test_3: ${TBIN} ${OBJ}/WyrazenieZesp.o 
	g++ -o ${TESTS}/bin/test_3 ${FLAGS} -I${TESTS}/doctest ${TESTS}/test3.cpp ${OBJ}/WyrazenieZesp.o

${TBIN}/test_4: ${TBIN} ${OBJ}/Statystyki.o 
	g++ -o ${TESTS}/bin/test_4 ${FLAGS} -I${TESTS}/doctest ${TESTS}/test4.cpp ${OBJ}/Statystyki.o


${TBIN}:
	mkdir ${TBIN}

test:  ${TBIN}/test_1 ${TBIN}/test_2 ${TBIN}/test_4
	${TBIN}/test_1 
	${TBIN}/test_2
	${TBIN}/test_4
